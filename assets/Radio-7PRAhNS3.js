import{f as c,g as t,I as o,G as F,H as n,d as H,h as l,bq as N,K as v,dk as O,j as M,aj as T,M as V,n as h,R as u}from"./index-BVg0SoX9.js";import{s as K,r as L}from"./RadioGroup-DdZCMr5F.js";const W=c("radio",`
...
`,[t("checked",[o("dot",`
 ...
 cursor: not-allowed;
 `)])]),q=Object.assign(Object.assign({},v.props),L),J=H({name:"Radio",props:q,setup(a){const e=K(a),i=v("Radio","-radio",W,O,a,e.mergedClsPrefix),s=h(()=>{const{mergedSize:{value:b}}=e,{common:{cubicBezierEaseInOut:x},self:{boxShadow:w,boxShadowActive:m,boxShadowDisabled:k,boxShadowFocus:z,boxShadowHover:C,color:R,colorDisabled:S,colorActive:y,textColor:$,textColorDisabled:_,dotColorActive:D,dotColorDisabled:P,labelPadding:j,labelLineHeight:B,labelFontWeight:E,[u("fontSize",b)]:I,[u("radioSize",b)]:A}}=i.value;return{"--n-bezier":x,"--n-label-line-height":B,"--n-label-font-weight":E,"--n-box-shadow":w,"--n-box-shadow-active":m,"--n-box-shadow-disabled":k,"--n-box-shadow-focus":z,"--n-box-shadow-hover":C,"--n-color":R,"--n-color-active":y,"--n-color-disabled":S,"--n-dot-color-active":D,"--n-dot-color-disabled":P,"--n-font-size":I,"--n-radio-size":A,"--n-text-color":$,"--n-text-color-disabled":_,"--n-label-padding":j}}),{inlineThemeDisabled:d,mergedClsPrefixRef:f,mergedRtlRef:p}=M(a),g=T("Radio",p,f),r=d?V("radio",h(()=>e.mergedSize.value[0]),s,a):void 0;return Object.assign(e,{rtlEnabled:g,cssVars:d?void 0:s,themeClass:r==null?void 0:r.themeClass,onRender:r==null?void 0:r.onRender})},render(){const{$slots:a,mergedClsPrefix:e,onRender:i,label:s}=this;return i==null||i(),l("label",{class:[`${e}-radio`,this.themeClass,this.rtlEnabled&&`${e}-radio--rtl`,this.mergedDisabled&&`${e}-radio--disabled`,this.renderSafeChecked&&`${e}-radio--checked`,this.focus&&`${e}-radio--focus`],style:this.cssVars},l("div",{class:`${e}-radio__dot-wrapper`}," ",l("div",{class:[`${e}-radio__dot`,this.renderSafeChecked&&`${e}-radio__dot--checked`]}),l("input",{ref:"inputRef",type:"radio",class:`${e}-radio-input`,value:this.value,name:this.mergedName,checked:this.renderSafeChecked,disabled:this.mergedDisabled,onChange:this.handleRadioInputChange,onFocus:this.handleRadioInputFocus,onBlur:this.handleRadioInputBlur})),N(a.default,d=>!d&&!s?null:l("div",{ref:"labelRef",class:`${e}-radio__label`},d||s)))}});export{J as N};
